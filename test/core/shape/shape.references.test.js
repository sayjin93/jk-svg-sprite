...
vi.mock('cssom', () => {
  ...
  // cssom is consumed via a default import, so the mock must provide one
...
describe('testing _replaceIdAndClassnameReferences()', () => {
  ...
  it('should return value of _replaceIdAndClassnameReferencesInCssSelectors() if selectors passed', () => {
    ...
    vi.spyOn(shape, '_replaceIdAndClassnameReferencesInCssSelectors').mockReturnValueOnce(TEST_RESULT);
