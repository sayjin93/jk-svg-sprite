import SVGSpriteCssPacker from '../../../lib/core/mode/css/packer.js';
...
describe('testing SVGSpriteCssPacker', () => {
  describe('testing constructor', () => {
    ...
    it('should set blocks and positions and ignore master shape', () => {
      ...
      const TEST_SHAPES = [{
        master: false, getDimensions: vi.fn().mockReturnValueOnce({ height: 0, width: 5 })
      }, {
        master: false, getDimensions: vi.fn().mockReturnValueOnce({ height: 5, width: 0 })
      }, {
        master: false, getDimensions: vi.fn().mockReturnValueOnce({ height: 6, width: 0 })
      }, {
        master: false, getDimensions: vi.fn().mockReturnValueOnce({ height: 0, width: 6 })
      }, {
        master: true, getDimensions: vi.fn()
      }];
  ...
  describe('testing _findNode', () => {
    ...
    describe('if root is used', () => {
      it('should return the result of _findNode with root.right', () => {
        ...
        vi.spyOn(packer, '_findNode').mockReturnValueOnce(RESULT);
      ...
      it('should return the result of _findNode with root.down if the result of _findNode, called with root.right returns falsy result', () => {
        ...
        vi.spyOn(packer, '_findNode').mockReturnValueOnce(null).mockReturnValueOnce(RESULT);
  ...
  describe('testing _growRight()', () => {
    it('should get node from _findNode and _splitNode it', () => {
      ...
      vi.spyOn(packer, '_findNode').mockReturnValueOnce({});
      vi.spyOn(packer, '_splitNode').mockReturnValueOnce(TEST_RESULT);
    ...
    it('should return false if node is not found', () => {
      ...
      vi.spyOn(packer, '_findNode').mockReturnValueOnce(null);
  ...
  describe('testing _growNode()', () => {
    it.each`
      ...
      vi.spyOn(packer, fnToCall).mockReturnValueOnce(TEST_RESULT);
      vi.spyOn(packer, fnNotToCall);
    ...
    it('should return null and not call _growRight() or _growBottom() if width and height is greater than the root`s ones', () => {
      ...
      vi.spyOn(packer, '_growBottom');
      vi.spyOn(packer, '_growRight');
  ...
  describe('testing fit()', () => {
    ...
    it('should set positions and split node if node is found', () => {
      ...
      vi.spyOn(packer, '_findNode').mockReturnValueOnce({});
      vi.spyOn(packer, '_splitNode').mockReturnValueOnce(TEST_NODE);
      vi.spyOn(packer, '_growNode');
    ...
    it('should set positions and grow node if node is not found', () => {
      ...
      packer.blocks = [{ width: 100, height: 200, index: 0 }];
      vi.spyOn(packer, '_findNode').mockReturnValueOnce(null);
      vi.spyOn(packer, '_growNode').mockReturnValueOnce(TEST_NODE);
      vi.spyOn(packer, '_splitNode');
