...
import SVGSprite from '../../lib/core/sprite.js';
...
describe('testing SVGSprite', () => {
  ...
  describe('testing add()', () => {
    ...
    it.each(
      [false, true, {}, vi.fn(), Symbol(''), 1, null, undefined, 'string']
  ...
  describe('testing toString()', () => {
    ...
    it('should transform svg in series', () => {
      ...
      const TEST_TRANSFORM = [vi.fn().mockReturnValueOnce(false), vi.fn().mockReturnValueOnce('TEST')];
  ...
  describe('testing toFile()', () => {
    it('should return file', () => {
      ...
      const sprite = new SVGSprite(false, false, {}, false, []);
      vi.spyOn(sprite, 'toString').mockReturnValueOnce(TEST_CONTENT);
