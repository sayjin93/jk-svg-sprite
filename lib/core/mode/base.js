...
/**
 * Absolute path to the package root, used to resolve the bundled `tmpl`
 * templates. Replaces `__dirname`, which does not exist in ESM.
 *
 * @type {string}
 */
const PACKAGE_ROOT = path.dirname(path.dirname(path.dirname(import.meta.dirname)));
